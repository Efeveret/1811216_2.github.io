...
if (isset($_POST['submit01'])) {
    ...
    $sqlUpdate = "INSERT INTO pb_update (`ProductBLID`,`INFO` ) VALUES ('$sprid', '$user01 added $TaskI to the product backlog')";
    $resultUpdate = mysqli_query($conn, $sqlUpdate);

    header("Location: ../Product_Backlog_Ref.php?loadSuccess");
    exit();
    ...
    if ($check>0){
        ...
        header("Location: ../Product_Backlog_Ref.php?alreadyexists");
        exit();
    } else{
    ...
    header("Location: ../Product_Backlog_Ref?loadSuccess");
    exit();
    ...
    header("Location: ../Product_Backlog_Ref?loadedspm");
    exit();
